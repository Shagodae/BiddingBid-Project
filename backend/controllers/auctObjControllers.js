import { Auction } from "../models/auctSchema.js";
...
export const addNewAuctionItem = catchAsyncErrors(async (req, res, next) => {
  ...
  if (
    ...
    return next(new ErrorHandler("Please provide all details.", 400)); //misising detail if any 
  }
  ...
  const alreadyOneAuctionActive = await Auction.find({   //active auction can't post more auction
